            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="buttons.php">Add Course</a>
                        <a class="collapse-item" href="utilities-color.php">Purchase Req</a>
                        <a class="collapse-item" href="cards.php">Demo Req</a>
                    </div>
                </div>
            </li>
